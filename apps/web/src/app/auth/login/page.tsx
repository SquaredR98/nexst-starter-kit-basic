        ...
        <div className="max-w-md w-full space-y-8 py-12">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-base text-gray-600">
              ...
              <Link href="/auth/register" className="font-semibold text-black hover:text-gray-700 transition-colors">
                Sign up for free
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-black items-center justify-center p-12 sticky top-0 h-screen">
        <div className="max-w-md text-white">
          <h2 className="text-4xl font-bold mb-6">
            Secure Authentication Built for Modern Apps
          </h2>
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            Enterprise-grade security with JWT tokens, OAuth integration, two-factor authentication, and comprehensive session management.
          </p>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Battle-tested authentication system</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white flex items-center justify-center mt-1">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Adapt to your brand and requirements</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white flex items-center justify-center mt-1">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Built with Next.js, NestJS & TypeScript</p>
              </div>
            </div>
          </div>
        </div>
